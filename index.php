    ...
    <div class="mt-3">
        ...
        while($row = $result->fetch_assoc()){
            ...
            <div class="border p-3 mb-2">
                ...
                <button class="<?php echo $is_active && !$is_completed ? 'bg-green-400' : 'bg-red-400 cursor-not-allowed'; ?> text-white p-1.5 mt-2" <?php if(!$is_active) echo 'disabled'; ?> <?php if($is_active) echo 'onClick="window.location.href=\'take_quiz.php?quizId=' . $row['id'] . '\'"'; ?>>
